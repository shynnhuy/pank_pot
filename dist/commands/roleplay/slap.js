    ...
    constructor() {
        this.execute = (message, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!message.mentions.users.first()) {
                embed.setTitle(`${message.author.username} tát.`);
                message.channel.send(embed);
                return true;
            }
            const taggedUser = message.mentions.users.first();
            embed.setTitle(`${message.author.username} tát sái quai hàm ${taggedUser === null || taggedUser === void 0 ? void 0 : taggedUser.username}.`);
            message.channel.send(embed);
            return true;
        });
    }
