    ...
    constructor() {
        this.execute = (message, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            const embed = new discord_js_1.MessageEmbed()
                ...
                .setTimestamp();
            if (args.length === 0) {
                const categories = [...new Set(index_1.client.$commands.map(command => command.info.category))];
            ...
            const command = index_1.client.$commands.get(args[0]) || index_1.client.$commands.get(index_1.client.$aliases.get(args[0]));
            if (!command)
